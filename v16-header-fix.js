...
for(const rel of ['dist/index.html','public/index.html']){
  ...
  const replacement=`function printHeader(){return '<div class="print-header"><img src="/group-header.jpg?v=20260903-1800" alt="灃禾集團表頭"></div>'}`;
...
console.log('Use corrected static /group-header.jpg for document header');
